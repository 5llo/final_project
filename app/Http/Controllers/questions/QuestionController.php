...
class QuestionController extends Controller
{
    ...
    public function all_cycles(Request $request)
    {
            $validator = Validator::make($request->all(), [
                'uuid' => ['required','exists:materials','max:255'],
            ...
            try {
                ...
                $cycles_nums = Material::findOrFail($material->id)->questions->where('is-master', $request['is-master'])->whereNotNull('year')->pluck('year');
